...
class ChampionshipDashboard < Administrate::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  # Overwrite this method to customize how championships are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(championship)
