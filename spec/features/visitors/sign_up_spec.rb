...
describe 'Sign Up', :devise do
  ...
  it 'visitor cannot sign up without password' do
    ...
    expect(page).to have_text 'Mot de passe doit être rempli(e)'
  end
  ...
  it 'visitor cannot sign up with a short password' do
    ...
    expect(page).to have_text 'Mot de passe est trop court (au moins 4 caractères)'
  end
  ...
  it 'visitor cannot sign up without password confirmation' do
    ...
    expect(page).to have_text 'Confirmation du mot de passe ne concorde pas avec Mot de passe'
  end
